...
export const $$: signatures.serializers.primitives.integer.iso_udhr = (udhr_day) => {
    ...
    const uhdr_to_iso_imp = (udhr_day: number): ISO_Date => {
        ...
        const number_of_400_year_blocks = _ps.integer.divide(total_days, number_of_days_in_400_years,  () => _ps.unreachable_code_path())
        const remaining_days_in_the_last_400_years = total_days % number_of_days_in_400_years

        const number_of_100_year_blocks = _ps.integer.divide(remaining_days_in_the_last_400_years, number_of_days_in_100_years, () => _ps.unreachable_code_path())
        const remaining_days_in_the_last_100_years = remaining_days_in_the_last_400_years % number_of_days_in_100_years

        const number_of_4_year_blocks = _ps.integer.divide(remaining_days_in_the_last_100_years, number_of_days_in_4_years, () => _ps.unreachable_code_path())
        const remaining_days_in_the_last_4_years = remaining_days_in_the_last_100_years % number_of_days_in_4_years

        const number_of_1_year_blocks = _ps.integer.divide(remaining_days_in_the_last_4_years, number_of_days_in_1_year, () => _ps.unreachable_code_path())
